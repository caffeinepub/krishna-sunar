...
export class Backend implements backendInterface {
    ...
    async getProductsBySector(arg0: SectorId): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsBySector(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSectors(): Promise<Array<Sector>> {
        if (this.processError) {
            try {
